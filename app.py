            ...
            if(file):
                ...
                if results:
                    ...
                    if len(results[0].boxes) > 0:
                        ...
                        confidence = float(results[0].boxes.conf[0]) * 100 # Convert to percentage
                        ...
                        if class_name:
                            if(class_name == "snake"):
                                ...
                                venom = "အဆိပ်ပျော့ရှိသည်"
                            else:
                                class_name = "Unknown"
                    else:
                        class_name = "No object detected"
                        confidence = 0.0
            return render_template('result.html', image_url=output_image_uri, uploaded_url=file_path, prediction=class_name, confidence=confidence, venom=venom)
